...
// takes the timed ones, and the Firefox project, on one worker, because a frame interval
// measured beside five other browsers is not the interval the budget states.
//
...
const timed = pass(
  ...
  ['--project=chromium-timed', '--project=firefox', '--workers=1'],
