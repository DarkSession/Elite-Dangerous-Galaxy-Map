...
| `12 - 2023-02-16.json`, the largest by records | 10.7 MB in, 943 records, 163 KB of minified JSON out        |
| `109 - 2024-12-26.json`               | 7 KB in, no record out                                               |
...
- No Canonn ED3D page. It is `publish-the-canonn-data-page`, and it waits for the change
  that raises the 10,000 system bound.
...
- **The committed cycle data grows the repository from 980 KB to about 19 MB** → The
